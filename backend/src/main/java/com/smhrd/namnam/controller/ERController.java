...
public class ERController {
    ...
    public List<AdmissionListView> findMedicalPatientsByDeepNcdss(@PathVariable("ncdss") String ncdss) {
    ...
    public List<AdmissionListView> findPastPatientsByWard(@PathVariable("Ward") String ward){
    ...
    public List<AdmissionListView> findPastPatientsByDeepNcdss(@PathVariable("ncdss") String ncdss) {
    ...
    public List<AdmissionListView> searchByPatientNameId(@PathVariable("patientNameId") String patientNameId){
    ...
    public List<AdmissionListView> nowSearchByPatientNameId(@PathVariable("patientNameId") String patientNameId){
    ...
    public List<AdmissionListView> pastSearchByPatientNameId(@PathVariable("patientNameId") String patientNameId){
