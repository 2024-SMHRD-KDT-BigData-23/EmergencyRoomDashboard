...
public interface StaffInfoRepository extends JpaRepository<StaffInfo, String> {
    ...
    // role페이지 user 추가
    @Modifying
    @Query(value = "INSERT INTO staff_info (hospital_id, staff_created_at, staff_id, staff_name, staff_role, staff_status, staff_pw) " +
            "VALUES (1, '2024-06-11 15:59:45.739771', :staffId, :staffName, :staffRole, 'inactive', :staffPw)",
            nativeQuery = true)
